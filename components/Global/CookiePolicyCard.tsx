				...
				>
					<div className="flex flex-col lg:flex-row items-center justify-center gap-2 lg:gap-10">
						<motion.h3
							...
							viewport={{once: true}}
							className="lg:min-w-[10rem] font-bold font-TeachersExtraBold text-5xl uppercase tracking-tight text-black leading-none text-center lg:text-left"
						>
							Our Cookie Policies
						</motion.h3>
						<div className="flex flex-col lg:flex-row items-center justify-between gap-6 w-full">
							...
							>
								<motion.button
									...
									whileInView={fadeInUp}
									viewport={{once: true}}
									className="inline-block px-6 py-3 font-TeachersExtraBold uppercase text-tiny leading-tight text-white transition-all duration-200 ease-in-out bg-primary-default hover:bg-primary-two"
								>
									Accept Cookies
								</motion.button>
								<motion.button
									...
									whileInView={fadeInUp}
									viewport={{once: true}}
									className="inline-block px-6 py-3 font-TeachersExtraBold uppercase text-tiny leading-tight text-white bg-primary-two hover:bg-primary-dark"
								>
									Refuse Cookies
								</motion.button>
							</motion.div>
					...
					<div className="hidden lg:flex flex-col lg:flex-row items-center justify-between gap-3 lg:gap-6 w-full">
						<div className="w-full lg:w-1/2">
							<motion.h3
								...
								whileInView={fadeInUp}
								viewport={{once: true}}
								className="font-bold font-TeachersExtraBold text-4xl sm:text-5xl uppercase tracking-tight text-black leading-tight text-center lg:text-left leading-none"
							>
						...
						>
							<span className="font-bold font-TeachersExtraBold uppercase text-xl text-white">
								Sponsored By
							</span>
