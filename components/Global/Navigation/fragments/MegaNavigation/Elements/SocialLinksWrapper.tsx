...
const SocialLinksWrapper: FC<ISocialLinksWrapper> = memo(({
    tiktokLink,
    youtubeLink,
    twitterLink,
    facebookLink,
    ...
    return (
        <>
            ...
            <motion.span
                {...commonMotionProps}
                className={facebookLink.url ? "block" : "hidden"}
            >
                <Link
                    className={styles.link}
                    href={`${facebookLink.url}`}
                    target={facebookLink.target || "_blank"}
            ...
            <motion.span
                {...commonMotionProps}
                className={twitterLink.url ? "block" : "hidden"}
            >
                <Link
                    className={styles.link}
                    href={`${twitterLink.url}`}
                    target={twitterLink.target || "_blank"}
            ...
            <motion.span
                {...commonMotionProps}
                className={linkedinLink.url ? "block" : "hidden"}
            >
                <Link
                    className={styles.link}
                    href={`${linkedinLink.url}`}
                    target={linkedinLink.target || "_blank"}
            ...
            <motion.span
                {...commonMotionProps}
                className={instagramLink.url ? "block" : "hidden"}
            >
                <Link
                    className={styles.link}
                    href={`${instagramLink.url}`}
                    target={instagramLink.target || "_blank"}
            ...
            <motion.span
                {...commonMotionProps}
                className={tiktokLink.url ? "block" : "hidden"}
            >
                <Link
                    className={styles.link}
                    href={`${tiktokLink.url}`}
                    target={tiktokLink.target || "_blank"}
                    aria-label={`TikTok Social Media Link ${tiktokLink.title}`}
                >
                    <svg
            ...
            <motion.span
                {...commonMotionProps}
                className={youtubeLink.url ? "block" : "hidden"}
            >
                <Link
                    className={styles.link}
                    href={`${youtubeLink.url}`}
                    target={youtubeLink.target || "_blank"}
                    aria-label={`YouTube Social Media Link ${youtubeLink.title}`}
                >
                    <svg
                        fill="none"
                        version="1.1"
