...
const TopNavigation: FC<INavbar.ITopNavigation.IProps> = memo(({
    revealGoogleTranslateOptions,
    handleRevealGoogleTranslateOptions
}) => {

    const globalContext = useGlobalContext();
    const scrollPosition = useScrollPosition();

    // Memoize common motion props to avoid re-creation on every render
    const commonMotionProps: any = useMemo(() => ({
        role: "button",
        type: "button",
        initial: initialTwo,
        whileInView: fadeIn,
                ...
                <div className={styles.googleTranslate}>
					...
					>
						<svg
							...
							fill={scrollPosition > 50 || revealGoogleTranslateOptions? "#000" :"#000"}
						>
                            <path
