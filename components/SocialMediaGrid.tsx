		...
		<>
			...
			>
				<ScrollYProgressReveal tailwindStyling="w-full">
					<Title
						content={title}
						tailwindStyling="title w-full mb-10 max-w-3xl mx-auto font-OnestBlack text-center uppercase text-3xl lg:text-5xl tracking-[-0.02rem] text-pureBlack font-semibold leading-tight"
					/>
