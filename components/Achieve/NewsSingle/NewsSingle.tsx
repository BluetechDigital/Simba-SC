...
import {INewsSingle} from "@/components/Achieve/NewsSingle/types/index";
...
import NewsletterElement from "@/components/Achieve/NewsSingle/fragments/NewsletterElement";
import NewsLatestArticles from "@/components/Achieve/NewsSingle/fragments/NewsLatestArticles";

const NewsSingle: FC<INewsSingle.IProps> = ({
	title,
	readTime,
	paragraph,
	articleType,
	...
	c0,24.99,20.34,45.33,45.32,45.33c24.99,0,45.32-20.34,45.32-45.33C273.18,202.88,252.85,182.55,227.86,182.55z"
					...
					<article className={styles.article}>
						<Paragraph
							...
							className={styles.boldParagraph}
						/>
						<Paragraph
							content={paragraph}
