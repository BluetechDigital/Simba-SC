...
import {getAllPartnershipsAdvertisingPagesSlugs} from "@/functions/graphql/Queries/GetAllPagesSlugs";
...
export async function getStaticPaths() {
	const data = await getAllPartnershipsAdvertisingPagesSlugs();
